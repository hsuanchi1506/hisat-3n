...
folly::MPMCQueue<string*>    linePool{QUEUE_CAPACITY};
folly::MPMCQueue<string*>    freeLinePool{QUEUE_CAPACITY};
folly::MPMCQueue<Position*>  freePositionPool{QUEUE_CAPACITY};
folly::MPMCQueue<Position*>  outputPositionPool{QUEUE_CAPACITY};
